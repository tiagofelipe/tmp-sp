...
export default {
  ...
  inject: {
    layout: {
      default () {
        console.error('ULayoutDrawer needs to be child of ULayout')
      }
    }
  },
  ...
  computed: {
    ...
    aboveClass () {
      return {
        ...
        'u-layout-drawer-mini': this.isMini,
        'u-layout-drawer-normal': !this.isMini,
        'u-layout-drawer-delimiter': this.fixed && this.showing,
  ...
  render (h) {
    ...
    return h('div', {
      staticClass: 'u-drawer-container'
    }, child.concat([
      h('aside', {
        ref: 'content',
        staticClass: `u-layout-drawer u-layout-transition u-layout-drawer-${this.side} scroll`,
