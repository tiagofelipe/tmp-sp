...
export default {
  ...
  inject: {
    layout: {
      default () {
        console.error('ULayoutFooter needs to be child of ULayout')
      }
    }
  },
  props: {
  ...
  computed: {
    ...
    computedClass () {
      return {
        ...
        'u-layout-footer-hidden': !this.canRender || !this.value || (this.fixed && !this.revealed)
      }
    },
    computedStyle () {
      const
  ...
  render (h) {
    return h('footer', {
      staticClass: 'u-layout-footer u-layout-transition',
