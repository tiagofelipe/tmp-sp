...
const
  ...
  Uloc = require('../dist/umd/uloc.mat.umd.min'),
  components = Uloc.components,
...
module.exports.generate = function () {
  writeFile(resolve('uloc-tags.json'), beautify(
    getTags(cache),
    null, 2, 1
  ))

  writeFile(resolve('uloc-attributes.json'), beautify(
    getAttributes(cache),
    null, 2, 1
  ))
}
