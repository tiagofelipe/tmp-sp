...
export default [
  ...
  mailFactory(2, 'Teste de e-mail respondido', 'testando...', tagColors.eleitores, true, false, true, true),
  mailFactory(3, 'E-mail com estrela', 'Testando com estrela', tagColors.campanha, false, false, true),
  mailFactory(4, 'E-mail excluído', 'E-mail de teste', tagColors.pesquisas, false, true, true, false),
